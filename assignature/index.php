...
<body>
	<div class="content">
		...
		<div style="margin-top: 30px;" class="row">
			...
			<?php
			$consulta = "SELECT * FROM assignatures ORDER BY id DESC LIMIT 10";
			$con = $conn->query($consulta) or die($conn->error);
			while($dado = $con->fetch_array()) { ?>
			<div class="col-6">
				<div class="module">
					<div style="background: url('../assets/img/assignatures/<?php echo $dado['image'] ?>');" class="assignaturePP"></div>
				</div>
			</div>
			<?php } ?>
